...
const styleSRC = './assets/css/scss/pickup-style.scss';
...
const zipName = 'woocommerce-local-pickup-plus.zip';
...
const textDomain = 'wc-local-pickup-plus';

// Name of the translation file.
const translationFile = 'wc-local-pickup-plus.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'wc-local-pickup-plus';

// Where can users report bugs.
const bugReport = 'https://micemade.com/';

// Last translator Email ID.
const lastTranslator = 'Alen Sirola <alen@micemade.com>';

// Team's Email ID.
const team = 'Alen Sirola <alen@micemade.com>';
